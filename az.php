...
if(file_exists("config.json")){
    ...
    $memberid = $arr2['id'];
    $hp = $arr2['hp'];
    echo "| Anjeun parantos login ngangge nomor $hp \n";
    echo "| 1. Daftar \n";
    echo "| Pilih: ";
...
daftar:
echo "| Asupkeun Nomor HP na atuh boss: ";
...
$random_name = "Jemmy"." ".substr(str_shuffle("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 4);
...
if($status_create !== "00"){
    ...
    echo "| SUKSES DAFTAR BOSS EUY NGOPI HEULA!!! \n";
    echo "| Nomor hpna $no_hp jeung passwordna zk168169 \n";
    echo "| Member Ponta $id_ponta \n";
    echo "| Loading voucher..mangga antosan!!!\n";
    sleep(4);
...
$heder_jadi = array(
 ...
 if($status == "00"){
    ...
    if($total_voucher == null){
        echo "| Yaaahh Voucher na Kosong euy :( !!! \n";
